...
def extractShapesFromPNG( filename ):
    """
    ...
    # Load the image
    original_image = cv2.imread(os.path.join(config['paths']['input'], "png", filename + ".png"), cv2.IMREAD_UNCHANGED)
    ...
    CONTAINER_DIR = os.path.join(config['paths']['shapes'], "png",  category)
